class PurchaseShipping
  ...
  def save
    ...
    Shipping.create(post_code: post_code, municipality: municipality, address: address, building_name: building_name, prefecture_id: prefecture_id, purchase: purchase.id)
  end
end